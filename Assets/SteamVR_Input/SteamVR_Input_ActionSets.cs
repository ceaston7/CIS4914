...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_mycontrols p_mycontrols;
        ...
        public static SteamVR_Input_ActionSet_mycontrols mycontrols
        {
            get
            {
                return SteamVR_Actions.p_mycontrols.GetCopy<SteamVR_Input_ActionSet_mycontrols>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_mycontrols = ((SteamVR_Input_ActionSet_mycontrols)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_mycontrols>("/actions/mycontrols")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.mycontrols};
        }
    }
}
